        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="<?php echo e(route('page.layout.config.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
...
</div><?php /**PATH /var/www/kisan-mart/resources/views/modules/cms/page/includes/modal_save_layout.blade.php ENDPATH**/ ?>