...
class Event extends Model
{
    ...
    {
        return $this->hasOne('App\Models\Cms\WebAlias', 'event_id');
    }
    ...
    {
        return $this->hasMany('App\Models\Addons\Event\EventContent', 'event_id')->orderBy('display_order', 'ASC');
    }

    public function seo()
    {
        return $this->hasOne('App\Models\Addons\Event\EventSeo', 'event_id');
    }
}
