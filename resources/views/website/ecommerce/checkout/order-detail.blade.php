    ...
    <div class="uk-container uk-container-xlarge">
        <div class="tm-grid-expand uk-child-width-1-1 uk-grid-margin" uk-grid>
            <div class="uk-text-center">
                <h2>Thank you for ordering! <br> One of our team member will contact you soon.</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="uk-section-default uk-section uk-padding-remove-top uk-padding-remove-bottom">
    <div class="uk-container">
        <div class="tm-grid-expand uk-grid-column-medium uk-grid-divider uk-grid-margin" uk-grid>
            ...
            $shipping = isset($order->shipping) ? $order->shipping : $order->billing;
            ...
            <div class="uk-width-1-3@m">
                ...
                <h2 class="uk-h3">Gift Voucher Option</h2>
                <div class="uk-panel uk-margin">{{ $gift_voucher_options[$order->gift_voucher_option] }}</div>
                @endif
            </div>
        </div>
    </div>
                    ...
                    <div>
                        <ul class="uk-list">
                            ...
                            <li>
                                <div class="uk-child-width-expand uk-grid-row-small uk-grid" uk-grid="">
                                    <div class="uk-width-auto uk-first-column">
                                        <div class="el-title uk-margin-remove uk-text-bold">VAT({{$order->vat_rate}})</div>
                                    </div>
                                    <div>
                            ...
                            <li>
                                <div class="uk-child-width-expand uk-grid-row-small uk-grid" uk-grid="">
                                    <div class="uk-width-auto uk-first-column">
                                        <div class="el-title uk-margin-remove uk-text-bold">@if($order->promo_code == null) GIFT VOUCHER @endif DISCOUNT</div>
                                    </div>
                                    <div>
    ...
    <div class="uk-container uk-card uk-card-default">
        <div class="tm-grid-expand uk-child-width-1-1 uk-grid-margin" uk-grid>
            ...
            <div class="uk-margin">
                <div class="el-item uk-panel uk-margin-remove-first-child">
                    <div class="uk-child-width-expand uk-grid-column-medium uk-grid" uk-grid="">
                        <div class="uk-width-auto uk-first-column"><span class="el-image uk-icon" uk-icon="icon: mail; width: 32; height: 32;"><svg width="32" height="32" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
