...
$delivery_instruction = $data->delivery_instructions ?? '';
@endphp
        ...
        <div class="uk-grid-margin uk-container">
            <div class="tm-grid-expand uk-child-width-1-1" uk-grid>
                <div>
                    ...
                    <div>
                        <form class="uk-form-stacked" action="{{ route('shipping.address.save') }}" method="POST">
                            @csrf()
                            ...
                            <div class="uk-margin">
                                <label class="uk-form-label" for="delivery_instructions">Delivery Instruction</label>
                                <div class="uk-form-controls">
                                    <textarea class="uk-textarea" name="delivery_instructions" id="delivery_instructions" placeholder="Delivery Instruction" rows="5">{{ $delivery_instruction }}</textarea>
                                </div>
                            </div>
