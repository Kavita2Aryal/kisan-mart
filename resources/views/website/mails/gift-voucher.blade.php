...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;margin:0">
    <head>
        ...
        <title>Gift Voucher | {{ $_msg_content['settings']['contact-title'] }}</title>
        <style type="text/css">
            #outlook a {
                padding:0;
            }
                                                                                ...
                                                                                <tbody>
                                                                                    <tr style="border-collapse: collapse;">
                                                                                        <td align="left" class="es-m-txt-c" style="padding: 0; margin: 0; font-size: 0;">
                                                                                            ...
                                                                                            >
                                                                                                <img
                                                                                                    src="{{ url('storage/website/logo.png') }}"
                                                                                                    alt=""
                                                                                                        ...
                                                                                                        @foreach($_msg_content['social_medias'] as $social_media)
                                                                                                            <td align="center" valign="top" style="padding: 0; margin: 0; padding-right: 10px;">
                                                                                                                <a target="_blank" rel="noopener noreferrer" href="{!! $social_media['link'] !!}">
                                                                                                                    <img
                                                                                                                        title="Facebook"
                                                                                                                        src="https://nzipxl.stripocdn.email/content/assets/img/social-icons/square-colored/{{ $social_media['social'] }}-square-colored.png"
                                                                                                                        alt="Fb"
                                                                                                                        width="32"
                                                                                                                        height="32"
                                                                                                                        style="display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;"
