        ...
        <div class="col-sm-12 col-lg-12">
            ...
            <div class="card card-borderless">
                ...
                <ul class="nav nav-tabs nav-tabs-simple" role="tablist">
                    <li class="nav-item">
                        <a class="active" href="{{ route('product.question.answer.pending') }}">Pending Questions</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('product.question.answer.replied') }}">Replied Questions</a>
                    </li>
                </ul>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" class="btn btn-link btn-link-fix p-l-10 p-r-10 m-b-5 text-success m-b-5 btn-reply" data-uuid="{{ $row->uuid }}">
                                            <i class="pg-icon m-r-5">pencil</i> REPLY
                                        </a>
