					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="pull-right">
								...
								<button class="btn btn-link btn-link-fix p-l-10 p-r-10 m-b-5 text-success save-selected-product" style="display: none;"><i class="fa fa-save"></i>SAVE SELECTED PRODUCTS</button>
							</div>
						</div>
					</div>
