...
<div class="container-fluid">
    <form class="m-t-20" role="form" method="POST" action="{{ route('country.store') }}">
        @csrf
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6 col-xlg-6">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title full-width">Create Country
                    ...
                    <div class="card-body">
                        <div class="form-group required form-group-default @error('country_code') has-error @enderror">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control @error('country_code') error @enderror" name="country_code" autocomplete="off" value="{{ old('country_code') }}">
                                @error('country_code')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 text-right">
                                <button class="btn btn-link btn-link-fix p-l-10 p-r-10" type="submit">
                                    CREATE <span class="visible-x-inline m-l-5">COUNTRY</span>
                                </button>
                            </div>
                        </div>
                    </div>
