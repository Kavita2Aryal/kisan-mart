...
<div class="container-fluid">
    <form class="m-t-20" class="form-product" method="POST" action="{{ route('product.store') }}" data-hyperlink-search="{{ route('web.alias.hyperlink.search', [0]) }}">
        @csrf
        <!-- Product Main Form -->
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title full-width">
                            ...
                            <button class="btn btn-link btn-link-fix p-l-10 p-r-10 m-r-5 pull-right" type="submit">
                                CREATE <span class="visible-x-inline m-l-5">PRODUCT</span>
                            </button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group form-group-default p-b-10 @error('short_description') has-error @enderror">
                            ...
                            <textarea name="short_description" class="form-control @error('short_description') error @enderror" style="height:50px;">{!! old('short_description') !!}</textarea>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title full-width">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xlg-12 col-lg-12 col-md-12">
                                    <div class="form-check danger form-check-inline switch switch-lg m-b-15">
                                        <input type="checkbox" name="has_variant" class="has-variant" id="has-variant">
                    ...
                    <div class="card-body is-variant-container display-none">
                                            ...
                                            <table class="table table-condensed">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width:200px; display:none;">SKU <strong class="text-danger">*</strong></th>
