...
@section('title', 'Product Category Report')
        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="card m-b-15">
                <div class="card-header">
                    <h5 class="no-margin">Product Category Report ({{ count($data) }})
                        <a href="{{ route('report.export.csv.product-category') }}" target="_blank" class="btn btn-link btn-link-fix p-l-10 p-r-10 pull-right m-r-5">
