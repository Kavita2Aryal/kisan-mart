...
@section('title', 'Cash on Delivery Report')
        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="card m-b-15">
                <div class="card-header">
                    <h5 class="no-margin">Cash on Delivery Report ({{ $data->total() }})
                    ...
                    <table class="table table-hover table-responsive-block">
                        <thead>
                            <tr>
                                ...
                                @endif
                                <th width="50">Delivery Charge (NPR)</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="50">
                                    <a class="btn btn-link btn-link-fix p-l-10 p-r-10 m-b-5 text-success btn-order-payment-status" data-type="payment-received" data-code="{{ $row->order_code }}" href="javascript:void(0);">
                                        <i class="fa fa-pencil"></i> {{ __('PAYMENT RECEIVED') }}
                                    </a>
                                </td>
                            </tr>
                            @endforeach
