                    ...
                    <div class="tab-pane active" id="pendingOrder">
                        <table class="table table-hover table-responsive-block">
                            ...
                            <tbody data-title="Product">
                                ...
                                $payment_type_check = get_list_group('payment_type_check');
                                @endphp
...
<script type="text/javascript">
    var refund_order_url = "{{ route('order.refund.save') }}";
    var cancel_order_url = "{{ route('order.cancel.save') }}";
    var cash_paid_url = "{{ route('order.payment.save') }}";
    ...
    var website_url = "{{ config('app.config.website_domain') }}";
    var url_thumb = "{{ url('storage/product/thumb/main/') }}";
    var url_main = "{{ url('storage/product/media/main/') }}";
</script>
