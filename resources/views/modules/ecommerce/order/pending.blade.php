                        ...
                        <table class="table table-hover table-responsive-block">
                            ...
                            <tbody data-title="Product">
                                ...
                                <tr data-code="{{ $row->order_code }}">
                                    ...
                                    <td>
                                        <a class="btn btn-link btn-link-fix p-l-10 p-r-10 m-b-5 text-success btn-order-status" data-type="confirm" data-code="{{ $row->order_code }}" href="javascript:void(0);">
                                            <i class="fa fa-pencil"></i> {{ __('CONFIRM ORDER') }}
                                        </a>
                                        ...
                                        <!-- <a class="btn btn-link btn-link-fix p-l-10 p-r-10 m-b-5 text-primary btn-view-order-detail" data-code="{{ $row->order_code }}" href="javascript:void(0)">
