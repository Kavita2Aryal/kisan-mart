                        ...
                        <table class="table table-hover table-responsive-block">
                            ...
                            <tbody data-title="Product">
                                ...
                                <tr data-code="{{ $row->order_code }}">
                                    ...
                                    <td>
                                        <a class="btn btn-link btn-link-fix p-l-10 p-r-10 m-b-5 text-warning btn-order-status" data-type="deliver" data-code="{{ $row->order_code }}" data-index="{{$i}}" href="javascript:void(0);">
                                            <i class="fa fa-pencil"></i> {{ __('DELIVER ORDER') }}
                                        </a>
...
<script type="text/javascript">
    var deliver_order_url = "{{ route('order.deliver.save') }}";
