...
<div class="container-fluid">
    <form class="m-t-20" role="form" method="POST" action="{{ route('brand.store') }}" data-hyperlink-search="{{ route('web.alias.hyperlink.search', [0]) }}">
        @csrf
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 text-right">
                                <button class="btn btn-link btn-link-fix p-l-10 p-r-10" type="submit">
                                    CREATE <span class="visible-x-inline m-l-5">BRAND</span>
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-5 col-xlg-5">
                <div class="card">
                    ...
                    <div class="card-body no-scroll no-padding">
                        ...
                        <input type="hidden" name="image" class="brand-image" value="" />
                    </div>
                </div>
                @if ($errors->has('image'))
