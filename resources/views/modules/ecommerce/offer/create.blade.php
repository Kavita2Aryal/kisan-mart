...
<div class="container-fluid">
    <form class="m-t-20" id="form" role="form" method="POST" action="{{ route('offer.store') }}" data-hyperlink-search="{{ route('web.alias.hyperlink.search', [0]) }}">
        @csrf
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-7 col-xlg-7">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title full-width">Create Offer
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group required form-group-default @error('title') has-error @enderror">
                            <label>Title</label>
                            <div class="controls">
                                <input name="title" type="text" class="form-control @error('title') error @enderror" required autocomplete="off" value="{{ old('title') }}">
                                @error('title')
                                <label class="error">{{ $message }}</label>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-group-default input-group @error('start_date') has-error @enderror required">
                                    <div class="form-input-group">
                                        ...
                                        <input type="text" class="form-control offer-start @error('start_date') error @enderror" name="start_date" placeholder="Pick a start date" autocomplete="off" value="{{ old('start_date') }}" data-provide="datepicker-inline">
                                        @error('start_date')
                                        <label class="error">{{ $message }}</label>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-group-default input-group @error('end_date') has-error @enderror">
                                    <div class="form-input-group">
                                        ...
                                        <input type="text" class="form-control offer-end @error('end_date') error @enderror" name="end_date" placeholder="Pick a end date" autocomplete="off" value="{{ old('end_date') }}" data-provide="datepicker-inline">
                                        @error('end_date')
                                        <label class="error">{{ $message }}</label>
                                        @enderror
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 text-right">
                                <button class="btn btn-link btn-link-fix p-l-10 p-r-10" type="submit">
                                    CREATE <span class="visible-x-inline m-l-5">OFFER</span>
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-5 col-xlg-5">
                <div class="card">
                    ...
                    <div class="card-body no-scroll no-padding">
                        ...
                        <input type="hidden" name="image" class="offer-image" value="{{ old('image') }}" />
                    </div>
                </div>
                @error('image')
                <label class="error">{{ $message }}</label>
