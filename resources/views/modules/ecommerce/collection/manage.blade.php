...
<div class="container-fluid m-t-20">
	<div class="card m-b-10">
		<div class="card-header">
			<div class="card-title full-width">Collection Management - <span class="text-success"> ({{$collection->name}}) </span>
				<a href="{{ route('collection.index') }}" class="normal btn btn-link pull-right" data-tippy-content="Go Back" data-tippy-placement="left"><i class="pg-icon">arrow_left</i></a>
			</div>
		</div>
		<div class="card-body">
...
'brands' => $brands,
'route' => route('collection.manage.save', [$collection->uuid])
])
...
<script>
	...
	var remove_selected_product = "{{ route('collection.remove.products', [$collection->uuid]) }}";
</script>
