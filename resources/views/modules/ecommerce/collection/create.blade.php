...
<div class="container-fluid">
    <form class="m-t-20" id="form" role="form" method="POST" action="{{ route('collection.store') }}" data-hyperlink-search="{{ route('web.alias.hyperlink.search', [0]) }}">
        @csrf
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-7 col-xlg-7">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title full-width">Create Collection
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-check form-check-inline complete">
                                    <input class="alias-level-1 alias-level-source" type="radio" name="collection_type" id="collection-type-{{ $key }}" data-alias="{{ Str::slug($type, '-') }}" value="{{ $key }}" @if ($key == 1) checked @endif>
                        ...
                        <div class="form-group required form-group-default @error('name') has-error @enderror">
                            <label>Name</label>
                            <div class="controls">
                                <input name="name" type="text" class="form-control alias-level-2 alias-level-source @error('name') error @enderror" required autocomplete="off" value="{{ old('name') }}">
                                @error('name')
                        ...
                        <div class="form-group form-group-default required input-group alias-edit @error('alias') has-error @enderror" style="display:none;">
                            ...
                            <div class="form-input-group">
                                <input type="text" class="form-control alias-value alias-check p-b-5 @error('alias') error @enderror" name="alias" placeholder="Web Alias" required autocomplete="off" value="{{ old('alias') ?? 'collection/' }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 text-right">
                                <button class="btn btn-link btn-link-fix p-l-10 p-r-10" type="submit">
                                    CREATE <span class="visible-x-inline m-l-5">COLLECTION</span>
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-5 col-xlg-5">
                <div class="card">
                    ...
                    <div class="card-body no-scroll no-padding">
                        ...
                        <input type="hidden" name="image" class="collection-image" value="{{ old('image') }}" />
                    </div>
                </div>
                @error('image')
                <label class="error">{{ $message }}</label>
