...
<div class="form-group row type-content">
    <div class="col-lg-12">
            ...
            <div class="col-md-7 text-right">
                <div class="form-check m-b-0 form-check-inline success">
                    <input type="radio" 
                        ...
                        class="has-type ignore-config-count" 
        ...
        <div class="row m-t-10 type-title" @if ($section['config'][$config] == 0) style="display: none;" @endif>
            <label class="col-md-12 control-label p-t-0">Select one or more Content Types:</label>
        </div>
        <div class="row m-t-10 type-option" @if ($section['config'][$config] == 0) style="display: none;" @endif>
            <div class="col-md-12">
                ...
                <div class="form-check info form-check-inline">
                    <input type="checkbox" 
                        ...
                        @if (count($section['type_config']) > 0 
                        && in_array($key, $section['type_config'])) checked @endif
                    />
