            ...
            <div class="card-body p-b-5">
                    ...
                    <div class="col-md-7 text-right">
                        <div class="form-check m-b-0 form-check-inline success">
                            <input type="radio" 
                                ...
                                @if ($list_config['head'][$item] == 1) checked @endif
                            />
                        ...
                        <div class="form-check m-b-0 form-check-inline danger m-r-0">
                            <input type="radio" 
                                ...
                                @if ($list_config['head'][$item] == 0) checked @endif
                            />
                ...
                <div class="form-group row number-content">
                    <div class="col-lg-12">
                        ...
                        <div class="row m-t-10 number-option" @if ($list_config['head'][$item] == 0) style="display:none;" @endif>
                            <label class="col-md-8 col-lg-8 col-xl-8 control-label p-t-0">No. of {{ $item }}</label>
                            <div class="col-md-4 col-lg-4 col-xl-4">
                                <input type="number" 
                                    value="{{ $list_config['head']['no_of_'.$item.'s'] }}"
                    ...
                    <div class="col-md-7 text-right">
                        <div class="form-check m-b-0 form-check-inline success">
                            <input type="radio" 
                                ...
                                @if ($list_config['body'][$item] == 1) checked @endif
                            />
                        ...
                        <div class="form-check m-b-0 form-check-inline danger m-r-0">
                            <input type="radio" 
                                ...
                                @if ($list_config['body'][$item] == 0) checked @endif
                            />
                ...
                <div class="form-group row number-content">
                    <div class="col-lg-12">
                        ...
                        <div class="row m-t-10 number-option" @if ($list_config['body'][$item] == 0) style="display:none;" @endif>
                            <label class="col-md-8 col-lg-8 col-xl-8 control-label p-t-0">No. of {{ $item }}</label>
                            <div class="col-md-4 col-lg-4 col-xl-4">
                                <input type="number" 
                                    value="{{ $list_config['body']['no_of_'.$item.'s'] }}"
                                    class="form-control input-sm" 
