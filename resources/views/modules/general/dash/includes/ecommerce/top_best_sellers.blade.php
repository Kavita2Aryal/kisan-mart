    ...
    <div class="widget-11 card">
        ...
        <div class="widget-11-table scroll-ing" style="overflow-y: auto; height: 400px;">
            <table class="table table-condensed table-hover">
                ...
                <tbody>
                    @forelse($top_best_sellers as $row)
                    <tr>
                        <td width="250" class="fs-12">
                            <a target="_blank" href="{{ $url . '/' . $row['alias'] }}">
                                {{ $row['name'] }}
                            </a>
                        </td>
        ...
        <div class="p-t-15 p-b-15 p-l-20 p-r-20">
            <p class="small no-margin pull-right">
                <a href="{{ route('report.best-seller') }}" class="hint-text font-montserrat"><strong> View All </strong></a>
            </p>
        </div>
    </div>
</div>