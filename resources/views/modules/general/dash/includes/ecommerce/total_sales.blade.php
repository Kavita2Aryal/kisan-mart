<div class="card bg-theme-green">
    <div class="card-header">
        <div class="card-title hint-text">
            <span class="font-montserrat fs-11 all-caps text-white">Total Sales</span>
        </div>
    </div>
    <div class="card-body">
        <div class="row">
