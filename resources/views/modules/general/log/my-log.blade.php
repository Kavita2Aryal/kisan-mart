...
<div class="container-fluid">
    <div class="row m-t-30">
        <div class="col-sm-12 col-lg-12">
            ...
            <form class="filter-log" action="{{ route('log.me') }}" method="GET">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group input-group transparent">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text transparent text-info">My Activity Log: Month</span>
                                    </div>
                            ...
                            <div class="col-md-9">
                                ...
                                <a href="{{ route('log.me') }}" class="btn btn-link btn-link-fix p-l-20 p-r-20 text-danger btn-lg">CLEAR</a>
                            </div>
                        </div>
