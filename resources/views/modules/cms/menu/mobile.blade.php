            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title full-width">
                        <div class="row">
                            <div class="col-lg-6">
                                <strong class="font-montserrat fs-18">Mobile Menu Builder</strong> <br/>   
                                <div class="form-check form-check-inline switch switch-lg m-t-10">
                                    <input type="checkbox" id="same-as-desktop" value="YES" @if(isset($same_as_desktop) && $same_as_desktop->value == 'YES') checked @endif>
                                    <label for="same-as-desktop"></label>
                                </div> 
                                <strong style="margin-left: -15px;">Same as desktop menu</strong>
                            </div>
                            <div class="col-lg-6">
                                <button type="button" class="btn btn-link btn-link-fix p-l-10 p-r-10 pull-right m-r-5 btn-save">
                                    SAVE MENU
                                </button>   
                                <input type="hidden" id="menu-type" value="mobile">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body menu-options" @if(isset($same_as_desktop) && $same_as_desktop->value == 'YES') style="display:none;" @endif>
                    <ul id="menu-builder" class="sortableLists list-group"></ul>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-5 col-lg-5 menu-options" @if(isset($same_as_desktop) && $same_as_desktop->value == 'YES') style="display:none;" @endif>
