<form action="{{ url()->current() }}" class="search-parent m-b-10 form-filter">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 col-xlg-4">
                <div class="form-group form-group-default input-group">
                    <div class="form-input-group">
                        ...
                        <select name="limit" class="form-control page-limit">
                            <option value="10" @if($data['itemsPerPage']==10) selected @endif>10 items</option>
                            <option value="25" @if($data['itemsPerPage']==25) selected @endif>25 items</option>
                            <option value="50" @if($data['itemsPerPage']==50) selected @endif>50 items</option>
                            <option value="100" @if($data['itemsPerPage']==100) selected @endif>100 items</option>
                        </select>
                    </div>
