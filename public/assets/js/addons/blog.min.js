...
$('.blog-date').datepicker();
$('.blog-keywords input.form-control').tagsinput();
$(document).on('blur', '.blog-keywords .bootstrap-tagsinput input', function (e) {
    if ($(this).val() != '') {
        $('.blog-keywords input.form-control').tagsinput('add', $(this).val());
        $(this).val('');
    }
});
