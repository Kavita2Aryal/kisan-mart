...
$('.news-keywords input.form-control').tagsinput();
$(document).on('blur', '.news-keywords .bootstrap-tagsinput input', function (e) {
    if ($(this).val() != '') {
        $('.news-keywords input.form-control').tagsinput('add', $(this).val());
        $(this).val('');
    }
});
